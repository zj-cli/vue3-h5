<template>
  <div class="flex-column align-center justify-center" style="height: 100%">
    ...
    <br />
    <van-button type="primary" to="/example?type=result">结果展示页</van-button>
    <br />
    <van-button type="primary" to="/example?type=upload">上传图片</van-button>
    <br />
    <van-button type="primary" to="/example?type=wrapper">资源容器</van-button>
    <br />
    <van-button type="primary" to="/example?type=wrapper">自定义返回</van-button>
    <br />
